...
import com.quanliren.quan_two.pull.lib.listeners.HeaderViewListener;
...
public class PullToRefreshAttacher {
    ...
    /**
     * Set a {@link com.quanliren.quan_two.pull.lib.listeners.HeaderViewListener} which is called when the visibility
