...
public class ChosePositionFragment extends Fragment{
	...
	@ViewById(R.id.edittext)EditText input;
	@ViewById(R.id.position_list)ListView listview;
	@ViewById(R.id.now_position)TextView now_position;
	@ViewById(R.id.layoutindex)LinearLayout layoutIndex;
	@ViewById(R.id.title_bar)TextView title_bar;
...
//		adapter.addFirstItem(new Area("全国", 990100, 990000, "qg"));
	...
	@ItemClick
	void position_list(int position){
