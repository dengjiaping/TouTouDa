...
import com.a.loopj.android.http.RequestHandle;
...
public class UserPicFragment extends MenuFragmentBase implements
	...
	public void imgClick(ImageBean id) {
		...
		if (position > -1)
			ImageBrowserActivity_.intent(this).mPosition(position)
					.mProfile(listSource).start();
	}
													...
													try {
														...
														case 0:
															...
															case 1:
																...
																if(getActivity()!=null)getActivity().sendBroadcast(i1);
																break;
															case 2:
																int index = 0;
																for (ImageBean ib : listSource) {
