...
package com.a.loopj.android.http;
 ...
 * </pre>
 *
 * @see com.a.loopj.android.http.AsyncHttpResponseHandler
 * @see com.a.loopj.android.http.ResponseHandlerInterface
 * @see com.a.loopj.android.http.RequestParams
 */
public class AsyncHttpClient {
     ...
     * @see com.a.loopj.android.http.MyRedirectHandler
     */
    ...
    public RequestHandle post(String url, RequestParams params, ResponseHandlerInterface responseHandler) {
    	com.quanliren.quan_two.util.LogUtil.d(LOG_TAG, url+"?"+params.toString());
