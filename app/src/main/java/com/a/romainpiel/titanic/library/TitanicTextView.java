package com.a.romainpiel.titanic.library;
...
public class TitanicTextView extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (sinking && shader != null) {
            ...
            System.out.println(maskX+"=========="+maskY);
    ...
    public void setProgress(int progress){
    	setSinking(true);
    	maskX=((float)progress/(float)100*(float)200);
    	maskY=((float)-progress/(float)100*(float)getHeight());
    	postInvalidate();
    }
}
